	...
	public function after_render(&$output)
	{
		...
		if (!$this->is_error)
		{
			$properties = array(
				...
				'og:title'				=> $this->meta['title'].' - '.$this->settings['site_title'], /* Added site title after page Title */
			...
			*/
			...
			/* Added Static Image */
			$properties['og:image'] = $this->settings['base_url'].'/img/curtis-stanier-og.png';
