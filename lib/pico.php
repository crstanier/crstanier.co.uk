	...
	protected function get_pages($base_url, $order_by = 'alpha', $order = 'asc', $excerpt_length = 50)
	{
		...
		foreach($pages as $key=>$page){
			...
			$data = array(
				...
				'summary' => isset($page_meta['summary']) ? $page_meta['summary'] : '',
				...
				'rating' => isset($page_meta['rating']) ? $page_meta['rating'] : '',
				'tagged' => isset($page_meta['tagged']) ? $page_meta['tagged'] : '',
				'summary' => isset($page_meta['summary']) ? $page_meta['summary'] : '',
				'bookauthor' => isset($page_meta['bookauthor']) ? $page_meta['bookauthor'] : '',
				'bookproductid' => isset($page_meta['bookproductid']) ? $page_meta['bookproductid'] : '',
				'booklink' => isset($page_meta['booklink']) ? $page_meta['booklink'] : ''
